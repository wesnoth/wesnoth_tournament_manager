...
ALTER TABLE match_schedule_proposals
ADD CONSTRAINT IF NOT EXISTS fk_proposal_user_id FOREIGN KEY (user_id) REFERENCES users_extension(id) ON DELETE SET NULL;

-- 3. Add indexes for expiration and user queries
ALTER TABLE match_schedule_proposals
