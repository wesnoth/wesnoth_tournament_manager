/**
 * IANA Timezone database (Backend)
 * Complete list of valid IANA timezone identifiers for server-side validation
 */
...
export const IANA_TIMEZONES = [
  ...
  // UTC and aliases
  'UTC', 'GMT', 'Greenwich', 'Universal', 'Zulu',

  // Legacy
  'Cuba', 'Egypt', 'Eire', 'Factory', 'GB', 'GB-Eire', 'Hongkong', 'HST', 'Iceland', 'Iran',
  'Israel', 'Jamaica', 'Japan', 'Kwajalein', 'Libya', 'MET', 'MST', 'Navajo', 'NZ', 'NZ-CHAT',
  'Poland', 'Portugal', 'PRC', 'ROC', 'ROK', 'Singapore', 'Turkey', 'UCT', 'W-SU', 'WET',
  'CET', 'CST6CDT', 'EET', 'EST', 'EST5EDT', 'MST7MDT', 'PST8PDT',
];
