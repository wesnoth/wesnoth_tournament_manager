      ...
      <div className="flex justify-between items-start gap-8 max-md:gap-4 max-md:flex-col mb-8">
        <div className="flex-1">
          ...
          <div className="flex gap-4 max-md:gap-2 flex-wrap">
            ...
            {player.global_ranking_position && (
              <span className="inline-block px-3 py-1 rounded text-sm max-md:text-xs font-semibold bg-purple-100 text-purple-800">
                {t('label_global_ranking_position', 'Global rank')}: #{player.global_ranking_position}
              </span>
            )}
